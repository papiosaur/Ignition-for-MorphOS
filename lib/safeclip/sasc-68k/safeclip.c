...
/* ASM prototypes */
LONG __asm clip2d (register __a0 LONG *, register __a1 LONG *, 
		   register __d0 LONG);
LONG __asm lineclip (register __a0 LONG *);
...
Clip2d (LONG n)
{
  return clip2d (CLP_vert[0], CLP_wrk[0], n);
}
/*********/
