...
extern void ASM closePrefScreenWin(REG(a0, struct Window *),REG(d0, BOOL)); // RA
...
extern void ASM initPrefCmdsWindow(REG(a0, struct winData *wd)); // RA
...
/**************************** prefs ****************************/
	...
	{MSG_PREFS_SCREEN_TITLE, "prefs_screen",								/* WDT_PREFSCREEN */
	 handlePrefScreenIDCMP, closePrefScreenWin, NULL, CreatePrefScreenGads, NULL,
	 0},
	...
	{MSG_PREFS_COMMANDS_TITLE, "prefs_commands",							/* WDT_PREFCMDS */
	 handlePrefCmdsIDCMP, closePrefCmdsWin, initPrefCmdsWindow, CreatePrefCmdsGads, NULL,
	 0},
